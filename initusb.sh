...
# standard 101 key keyboard report descriptor
...
# media keyboard report descriptor
echo 0 > functions/hid.g1/protocol
echo 0 > functions/hid.g1/subclass
echo 1 > functions/hid.g1/report_length
bash -c 'echo -ne \\x05\\x0c\\x09\\x01\\xa1\\x01\\x15\\x00\\x25\\x01\\x09\\xe9\\x09\\xea\\x09\\xe2\\x75\\x01\\x95\\x03\\x81\\x02\\x75\\x01\\x95\\x05\\x81\\x03\\xc0 > functions/hid.g1/report_desc'
